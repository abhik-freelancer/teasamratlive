...
<!--    	<input type="text" id="txtBlendingRef" name="txtBlendingRef" value=""/>	-->
  ...
  <tr>
    <td>Date</td>
    <td><input type="text" name="txtBlendingDt" id="txtBlendingDt" class="datepicker" value="<?php echo date('d-m-Y');?>"/></td>
    <td>Warehouse</td>
    <td>
...
<div id="dialog-for-refrenceno" title="Blending" style="display:none;">
       <span> This Refrence No already exist. </span>
</div>
...
<span class="buttondiv">
          <div class="save" id="saveBlend" align="center" style="display:block;">Save</div>
      </span>
