...
<body>
   <table width="100%" border="0"  style="font-size:1mm !important">
        <tr>
            <td width="25%"></td>
            ...
            <td width="30%" align="right"><span style="font-family: Verdana, Geneva, sans-serif; font-size:10px;font-weight:bold;"> ORIGINAL BUYER'S COPY / SELLER'S COPY / TRANSPORTER'S COPY</span></td>
        </tr>
