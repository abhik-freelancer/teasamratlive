<script src="<?php echo base_url(); ?>application/assets/js/addRawTeaSale.js"></script> 

 <h1><font color="#5cb85c" style="font-size:24px;">Garden Tea Sale List</font></h1>
 <div class="stats">
 
        <p class="stat"><a href="<?php echo base_url(); ?>rawteasale/addRawTeaSale" class="showtooltip" title="add"><img src="<?php echo base_url(); ?>application/assets/images/add.jpg" hieght="38" width="38" /></a></p>
