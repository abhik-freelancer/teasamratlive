...
<h2><font color="#5cb85c">Raw Tea Sale :: Modify</font></h2>
...
<table class="masterTable" width="80%" align="center">
  ...
  <tr>
        ...
        <td width="20%"><input type="text" name="invoice_no" id="invoice_no" style="width:240px;" value="<?php echo $bodycontent['rawteasaleMastData']['invoice_no']?>" readonly="readonly"/></td>
...
<div id='stockDiv'>
 ...
 <section id="loginBox">
  ...
  <tr>
    ...
    <td><input type="text" id="txtTotalSaleBag" name="txtTotalSaleBag" value="<?php echo $bodycontent['rawteasaleMastData']['total_sale_bag']?>"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>Total Sale(Kgs)</td>
    <td><input type="text" id="txtSaleOutKgs" name="txtSaleOutKgs" value="<?php echo $bodycontent['rawteasaleMastData']['total_sale_qty']?>"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td>Total Amount</td>
    <td><input type="text" id="txtTotalSalePrice" name="txtTotalSalePrice" value="<?php echo $bodycontent['rawteasaleMastData']['totalamount']?>"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>Discount</td>
    <td><input type="text" name="txtDiscountPercentage" id="txtDiscountPercentage" value="<?php echo $bodycontent['rawteasaleMastData']['discountRate']?>" />(%) </td>
    <td>Amount</td>
    <td><input type="text" id="txtDiscountAmount" name="txtDiscountAmount" value="<?php echo $bodycontent['rawteasaleMastData']['discountAmount']?>"/></td>
  </tr>

  <tr>
    <td>Delivery Chgs</td>
    <td><input type="text" name="txtDeliveryChg" id="txtDeliveryChg" value="<?php echo $bodycontent['rawteasaleMastData']['deliverychgs']?>" /></td>
    <td></td>
    <td></td>
  </tr>
  ...
  <tr>
    ...
    <td>Tax Amount</td>
    <td><input type="text" id="txtTaxAmount" name="txtTaxAmount" value="<?php echo $bodycontent['rawteasaleMastData']['taxamount']?>"/></td>
  </tr>
  
  <tr>
    <td>Round off</td>
    <td><input type="text" id="txtRoundOff" name="txtRoundOff" value="<?php echo $bodycontent['rawteasaleMastData']['roundoff']?>"/></td>
    <td>&nbsp;</td>
    <td></td>
  </tr>
  ...
  <tr>
    <td>Total</td>
    <td><input type="text" id="txtGrandTotal" name="txtGrandTotal" value="<?php echo $bodycontent['rawteasaleMastData']['grandtotal']?>"/></td>
    <td></td>
    <td></td>
  </tr>
