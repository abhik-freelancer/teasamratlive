...
<table width="100%" border="0">
  <tr style="display:none;">
   ...
   <tr>
       ...
       <td>Voucher Date:</td>
       <td><input type="text" name="voucherDate" id="voucherDate" class="datepicker textStyle" value="<?php //echo $bodycontent['generalVouchermaster']['voucher_date'];
        if($bodycontent['generalVouchermaster']['voucher_date']){echo $bodycontent['generalVouchermaster']['voucher_date'];}else{echo date('d-m-Y');}
       ?>" /></td>
       <td>Receipt/Payment:</td>
       <td>
           <select name="paymentmode" id="paymentmode" class="paymentmode selectStyle" style="width:100px;" <?php if($modeType=="Edit"){echo "disabled";}else{echo "";}?>>
   ...
   <tr>
       ...
       <td>Cheque No:</td>
       <td>
           <input type="hidden" value="<?php echo $bodycontent['generalVouchermaster']['cheque_number']?>" id="hidenChqno" />
           <input type="text" name="chqNo" id="chqNo" class="textStyle" value="<?php echo $bodycontent['generalVouchermaster']['cheque_number']?>" style="width:100px;"
            <?php if($bodycontent['generalVouchermaster']['groupname']=="Cash Balance"){echo "disabled";}else{"";}?>       
             /></td>
   </tr>
   <tr>
       <td>&nbsp;</td>
   ...
   <tr>
       <td>Cheque Date:</td>
       <td>
           <input type="hidden" value="<?php echo $bodycontent['generalVouchermaster']['cheque_date']?>" id="hidenChqdate" />
           <input type="text" name="chqDate" id="chqDate" value="<?php echo $bodycontent['generalVouchermaster']['cheque_date']?>" class="datepicker textStyle" 
                  <?php if($bodycontent['generalVouchermaster']['groupname']=="Cash Balance"){echo "disabled";}else{"";}?>
                  /></td>
       <td>Amount:</td>
       ...
       <td>
           <select name="branchid" id="branchid" class="branch selectStyle">
              ...
              <?php foreach($header['branchlist'] as $rows){?>
                <option value="<?php echo($rows['id'])?>" <?php if($rows['id']==$bodycontent['generalVouchermaster']['branchid']){echo("selected='selected'");}else{echo('');}?>><?php echo($rows['branch']); ?></option>
            <?php } ?>
           </select>
   ...
   <tr>
       <td>Narration:</td>
       <td colspan="6">
           <textarea id="narration" name="narration" cols="18" rows="" class="textStyle" style="width:567px;"><?php echo $bodycontent['generalVouchermaster']['narration']?></textarea>
       </td>
   </tr>
      <tr>
       <td>&nbsp;</td>
