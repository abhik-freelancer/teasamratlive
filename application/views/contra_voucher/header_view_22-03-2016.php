...
<table width="100%" border="0">
  <tr style="display:none;">
   ...
   <tr>
       ...
       <td>Voucher Date:</td>
       <td><input type="text" name="voucherDate" id="voucherDate" class="datepicker textStyle" value="<?php echo $bodycontent['contraVouchermaster']['voucher_date'];?>" /></td>
       ...
       <td>
           <select name="unitid" id="unitid" class="unit selectStyle">
              ...
              <?php foreach($header['unitlist'] as $rows){?>
                <option value="<?php echo($rows['unitid'])?>" <?php if($bodycontent['contraVouchermaster']['unitid']== $rows['unitid']){echo('selected');}else{echo('');} ?>><?php echo($rows['unitName']); ?></option>
            <?php } ?>
           </select>
         </td>
          <td>Narration:</td>
