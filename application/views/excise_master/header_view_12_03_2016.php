      ...
      <input type="hidden" id="txtModeOfoperation" name="txtModeOfoperation" value="<?php echo($header['mode']); ?>"/>
        ...
        <table width="100%">
            ...
            <tr>
                <td>Rate:</td>
                 <td>:&nbsp;&nbsp;</td>
                <td> <input type="text" id="rate" name="rate" class="textStyle" value="<?php echo $bodycontent['exciseMaster']['rate'];?>"/></td>
            </tr>
             <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                <td>Description </td>
                <td>:&nbsp;&nbsp;</td>
                <td><textarea id="description" name="description" class="textStyle"><?php echo $bodycontent['exciseMaster']['description'];?></textarea></td>
            </tr>
        </table>
  </section>
