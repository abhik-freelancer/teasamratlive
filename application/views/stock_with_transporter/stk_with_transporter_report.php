                                 ...
                                 <?php 
                                     ...
                                     $grandTotalbag = $grandTotalbag+($content->totalBags);
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="6" align="right"><strong><?php echo number_format($grandTotalbag);?></strong></td>
                                                <td colspan="2" align="right"><strong><?php echo number_format($grandQty,2);?></strong></td>
                                                <td colspan="2" align="right"><strong><?php echo number_format($grandTotalAmount,2);?></strong></td>
                                            </tr>
