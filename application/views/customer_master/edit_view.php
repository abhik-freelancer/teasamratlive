        ...
        <section id="loginBox" style="width:500px;">
                ...
                <label for="tin">VAT no:
                 ...
                 <label for="Telephone">Telephone
                  ...
                  <label for="creditdays">Credit Days
                    <br />
                    <input type="text" id="creditdays" name="creditdays" class="creditdays"  value="<?php echo trim($bodycontent['data'][0]->credit_days);?>" onkeypress="checkNumeric(this);"/>
                  </label>
