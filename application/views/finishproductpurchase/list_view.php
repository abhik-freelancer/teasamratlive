<script src="<?php echo base_url(); ?>application/assets/js/taxInvoice_fprod.js"></script> 
 ...
 <h2><font color="#5cb85c">Finish Product Purchase</font></h2>
 <div class="stats">
 
    <p class="stat"><a href="<?php echo base_url(); ?>finishproductpurchase/addTaxInvoice" class="showtooltip" title="add">
	...
	<?php 
        ...
        if($bodycontent)  : 
         ...
         <tr>
             ...
             <td>
                 <a href="<?php echo base_url(); ?>finishproductpurchase/addTaxInvoice/id/<?php echo($content['id']); ?>" class="showtooltip" title="Edit">
