<script src="<?php echo base_url(); ?>application/assets/js/taxInvoiceAdd_fprod.js"></script>
...
<h2><font color="#5cb85c">Add bill</font></h2>
<?php }else{?>
<h2><font color="#5cb85c">Edit bill</font></h2>
<?php } ?>
...
<table width="100%" border="0" align="center" >
  ...
  <tr>
    ...
    <td>
        ...
        <input type="text"  id="txtSaleBillNo" name="txtSaleBillNo" class="salebillNo"  
               value="<?php echo($bodycontent['taxInvoiceMaster']['purchasebillno']); ?>" style="width:300px;"/>
    </td>
  </tr>
  ...
  <tr><td colspan="5">&nbsp;</td></tr>
   ...
   <tr>
        ...
        <td>
            <select id="vendor" name="vendor" class="customer custom-select" style="width:300px;">
                    <option value="0">Select</option>
                <?php foreach($header['vendor'] as $rows){?>
                    <option value="<?php echo($rows['vendorId']); ?>" <?php if($bodycontent['taxInvoiceMaster']['vendorId']==$rows['vendorId']){echo('selected');}else{echo('');} ?>><?php echo($rows['name']); ?></option>
                <?php } ?>
            </select>
        </td>
