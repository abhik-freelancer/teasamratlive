...
if ($leftmenu) :
    foreach ($leftmenu['detail'] as $lcontent) :
        ...
        <input type="hidden" value="<?php echo $lcontent->id; ?>" id="<?php if($lcontent->id ==3 ){echo 'mastermenu';}else if($lcontent->id ==27){echo 'transactionmenu';}else if($lcontent->id ==31){ echo 'reportmenu';}else{echo '';} ?>"/> 
