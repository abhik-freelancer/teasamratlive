                ...
                foreach ($trialbalance as $trial_blnc) {
                    ...
                    ?>
                     <tr>
                        ...
                        <td align="right"><?php echo $trial_blnc['debit'];?></td>
                        <td align="right"><?php echo $trial_blnc['credit'];?></td>
                        <td align="right"><?php echo $trial_blnc['closingDebit'];?></td>
                        <td align="right"><?php echo $trial_blnc['closingCredit'];?></td>
                    ...
                    ?>
                    <tr>
                        <td colspan="2" align="center"><b>Page Total</b></td>
