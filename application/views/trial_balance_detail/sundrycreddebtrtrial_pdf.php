<html>
    ...
    <body>
       ...
       <table width="100%">
            <tr><td align="center"><b>Trial Balance for <?php echo $group['group_name']; ?> </b><br><span style="font-size:12px;">(<?php echo $fromDate." To ".$toDate?>)</span></td></tr>
        </table>
       ...
       <table width="100%" class="demo">
        ...
        <tr>
            ...
            if ($sundrycreddebtrtrial) {
                foreach ($sundrycreddebtrtrial as $trial_blnc) {
