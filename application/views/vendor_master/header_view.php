 ...
 <div class="stats">
    ...
    <p class="stat"><a class="showtooltip" title="add" href="<?php echo base_url(); ?>vendormaster/addpage"><img src="<?php echo base_url(); ?>application/assets/images/add.jpg" hieght="30" width="30"/></a></p>
 ...
 <h1><font color="#5cb85c">List of Vendors</font></h1>
