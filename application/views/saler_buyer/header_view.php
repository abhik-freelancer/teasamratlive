<script src="<?php echo base_url(); ?>application/assets/js/salertobuyer.js"></script> 
 ...
 <h1><font color="#5cb85c">List of Seller to Buyer</font></h1>
 <div class="stats">
 
    <p class="stat"><a href="<?php echo base_url(); ?>salertobuyer" class="showtooltip" title="add"><img src="<?php echo base_url(); ?>application/assets/images/add.jpg" hieght="38" width="38" /></a></p>
