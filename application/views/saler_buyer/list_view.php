         ...
         <?php 
            ...
            if(count($bodycontent) > 0)  : 
                ...
                <tr id="row<?php echo $content->id; ?>">
                     <td>
                     <a href="<?php echo base_url(); ?>salertobuyer/edit/invoice/<?php echo $content->id; ?>" class="opendetail showtooltip" title="edit" id="<?php echo $content->id; ?>"><img src="<?php echo base_url(); ?>application/assets/images/edit.jpg" height="18" width="18" /></a>
                    ...
                    <td><?php echo $content->salertobuyer_invoice_number; ?> </td>
                    <td><?php echo $content->salertobuyer_invoice_date; ?> </td>
