<script src="<?php echo base_url(); ?>application/assets/js/salertobuyer.js"></script>

 <h2><font color="#5cb85c">Manage Seller to Buyer</font></h2>
 <form role="form" method="post" name="addsalertobuyer" id="addsalertobuyer" action="<?php echo base_url(); ?>salertobuyer/update/invoice/<?php echo $bodycontent['invoiceid']; ?>" method="post">

  <section id="loginBox" style="width:800px;">
     <table cellspacing="4" cellpadding="0" class="tablespace" >
                   <tr>
                    <td scope="row">Invoice Number</td>
                    <td><input type="text" name="taxinvoice" id="taxinvoice" value="<?php echo $bodycontent['saveddata'][0]->salertobuyer_invoice_number; ?>"/></td>
                    <td/>
                    ...
                    <td><input type="text" class="datepicker" id="taxinvoicedate" name="taxinvoicedate" value="<?php echo date("d-m-Y", strtotime($bodycontent['saveddata'][0]->salertobuyer_invoice_date)); ?>"/></td>
                    <td/>
...
<table class="display" cellspacing="0" width="100%"  id="example2"  frame="box">
	...
	?>
        ...
        <td><span id="lot<?php echo  $detaildata->id; ?>"><?php echo $detaildata->lot; ?></span> <input type="hidden" name="detailtableid[]" id="detailtableid<?php echo  $detaildata->id; ?>" value="<?php echo $detaildata->id; ?>" /><input type="hidden" name="detaillot[]" value="<?php echo $detaildata->lot; ?>" /></td>
       ...
       <span id="teagroup<?php echo  $detaildata->id; ?>"><?php echo $detaildata->teagroupcode; ?></span><input type="hidden"  id="detailteagroupid<?php echo  $detaildata->id; ?>" name="detailteagroupid[]" value="<?php echo $detaildata->teagroupid; ?>"/></td>
        ...
        <td><table><tr>
        <td><span id="sample<?php echo $detaildata->id; ?>"><?php echo str_replace(",","</br>",$detaildata->samplenumber)?></span><input type="hidden"  name="detailsamplename[]" value="<?php echo str_replace(",","*",$detaildata->samplenumber)?>"/></td>
        <td> => </td>
       ...
       <input type="hidden" class="fieldcstrate" name="fieldcstrate[]" value="<?php if($detaildata->rate_type == 'C') { echo $detaildata->rate_type_value; }?>"/>
        ...
        <td><img src="<?php echo base_url(); ?>application/assets/images/delete.png" height='18' width='18' onclick='deleterowdb("detailtr",<?php echo $detaildata->id; ?>,<?php echo $detaildata->invoice_number; ?>)'/><img src="<?php echo base_url(); ?>application/assets/images/edit.jpg" height='20' width='20' onclick='editrow("detailtr",<?php echo $detaildata->id; ?>)'/></td></tr>
	 <?php
     }
	 ?>
