<script src="<?php echo base_url(); ?>application/assets/js/privatesell.js"></script>
 ...
 <h2><font color="#5cb85c">Manage Private Sell</font></h2>
 <form role="form" method="post" name="addinvoice" id="addinvoice" action="<?php echo base_url(); ?>privatesell/update/invoice/<?php echo $bodycontent['invoiceid']; ?>" method="post">
                  ...
                  <table cellspacing="4" cellpadding="0" class="tablespace" width="100%" style=" margin-left: 2cm;" id="popupwindow">
                  	<tr>
                    	<td>
                        	  <table class="tablespace" >
                                       <tr>
                                        <td scope="row">LOT</td>
                                        <td><input type="text" id="lot" name="lot"  onkeyup="checkNumeric(this);"/></td>
                                        <td/>
                                       </tr>
                                       <tr>
                                        <td scope="row">DO</td>
                                        <td><input type="text" id="do" name="do" onkeyup="checkNumeric(this);"/></td>
                                       </tr>
                                       <tr>
                    ...
                    <tr>
                        ...
                        <td>
                        					<table class="tablespace" >
                                            	<tr>
                                            <td scope="row" valign="top">Sample &nbsp;<a href="javascript:void(0)" ><img src="<?php echo base_url(); ?>application/assets/images/add_sample.jpg" height="18" width="18" id="addsample"/></a><input type="hidden" name="samplecount" id="samplecount" value=""/></td>
                                            ...
                                            <span id="currentvatrate">
                                            	 <select id="optionrate" name="optionrate" class="optionrate"><option value="0">Select a rate</option>
...
<table class="display" cellspacing="0" width="100%"  id="example2"  frame="box">
	...
	?>
        ...
        <td><span id="lot<?php echo  $detaildata->id; ?>"><?php echo $detaildata->lot; ?></span> <input type="hidden" name="detailtableid[]" id="detailtableid<?php echo  $detaildata->id; ?>" value="<?php echo $detaildata->id; ?>" /><input type="hidden" name="detaillot[]" value="<?php echo $detaildata->lot; ?>" />
        <br/><span id="do<?php echo  $detaildata->id; ?>"><?php echo $detaildata->do; ?></span><input type="hidden" name="detaildo[]" value="<?php echo $detaildata->do; ?>" /></td>
        <td><span id="invoice<?php echo  $detaildata->id; ?>"><?php echo $detaildata->invoice_number; ?></span><input type="hidden" name="detailinvoice[]" value="<?php echo $detaildata->invoice_number; ?>" /></td>
        <td><span id="garden<?php echo  $detaildata->id; ?>"><?php echo $detaildata->garden_name; ?></span><input type="hidden" id="detailgardenid<?php echo  $detaildata->id; ?>" name="detailgardenid[]" value="<?php echo $detaildata->garden_id; ?>"/><br/>
        <span id="warehouse<?php echo  $detaildata->id; ?>"><?php echo $detaildata->name; ?></span><input type="hidden"  id="detailwarehouseid<?php echo  $detaildata->id; ?>" name="detailwarehouseid[]" value="<?php echo $detaildata->warehouse_id; ?>"/>
        <br/>
        <span id="teagroup<?php echo  $detaildata->id; ?>"><?php echo $detaildata->teagroupcode; ?></span><input type="hidden"  id="detailteagroupid<?php echo  $detaildata->id; ?>" name="detailteagroupid[]" value="<?php echo $detaildata->teagroupid; ?>"/></td>
        <td><span id="grade<?php echo  $detaildata->id; ?>"><?php echo $detaildata->grade; ?></span><input type="hidden"  id="detailgradeid<?php echo  $detaildata->id; ?>" name="detailgradeid[]" value="<?php echo $detaildata->grade_id; ?>"/><br/>
        <span id="chest<?php echo $detaildata->id; ?>"><?php echo ($detaildata->chest_from .' - '.$detaildata->chest_to) ; ?></span><input type="hidden" id="detailchfrom<?php echo $detaildata->id; ?>" name="detailchfrom[]" value="<?php echo ($detaildata->chest_from) ; ?>"/><input type="hidden"  id="detailchto<?php echo $detaildata->id; ?>" name="detailchto[]" value="<?php echo ($detaildata->chest_to) ; ?>"/></td>
        <td><span id="gpnumber<?php echo  $detaildata->id; ?>"><?php echo $detaildata->gp_number; ?></span><input type="hidden"  name="detailgpno[]" value="<?php echo $detaildata->gp_number; ?>"/>
        <br/><span id="gpdate<?php echo  $detaildata->id; ?>"><?php echo date("d-m-Y", strtotime($detaildata->date)); ?></span><input type='hidden' name='detaildate[]' value='<?php echo $detaildata->date; ?>'/></td>
        <td><span id="package<?php echo  $detaildata->id; ?>"><?php echo $detaildata->package; ?></span><input type="hidden"  name="detailpackage[]" value="<?php echo $detaildata->package; ?>"/>
        <br/><span id="stamp<?php echo  $detaildata->id; ?>"><?php echo $detaildata->stamp; ?></span><input type="hidden"  name="detailstamp[]" value="<?php echo $detaildata->stamp; ?>"/>
        <br/><span id="net<?php echo  $detaildata->id; ?>"><?php echo $detaildata->net; ?></span><input type="hidden"  name="detailnet[]" value="<?php echo $detaildata->net; ?>"/></td>
        <td><table><tr>
        <td>
            <?php 
            ...
            <span id="sample<?php echo $detaildata->id; ?>"><?php echo str_replace(",","</br>",$detaildata->samplenumber)?></span>
            <input type="hidden"  name="detailsamplename[]" value="<?php echo str_replace(",","*",$detaildata->samplenumber)?>"/>
        </td>
        <td> => </td>
        ...
        <td><span id="gross<?php echo $detaildata->id; ?>"><?php echo $detaildata->gross; ?></span><input type="hidden"  name="detailgross[]" value="<?php echo $detaildata->gross; ?>"/><br/>
		<span id="brokerage<?php echo $detaildata->id; ?>"><?php echo $detaildata->brokerage; ?></span><input type="hidden"  name="detaillistbrokerage[]" value="<?php echo $detaildata->brokerage; ?>"/></td>
        <td><span id="tweigh<?php echo $detaildata->id; ?>"><?php echo $detaildata->total_weight; ?></span><input type="hidden" name="detaillisttweight[]" value="<?php echo $detaildata->total_weight; ?>"/>
        <br/><span id="vat<?php echo $detaildata->id; ?>">
        <?php
		...
		<?php echo $type.' => '.$detaildata->rate_type_value; ?> </span>
        ...
        <input type="hidden"  name="detailvat[]" id="ratetypevalue<?php echo $detaildata->id; ?>"  class="ratetypevalue" value="<?php echo $detaildata->rate_type_value; ?>"/>
         <input type="hidden" class="fieldvatrate" name="fieldvatrate[]" value="<?php if($detaildata->rate_type == 'V') { echo $detaildata->rate_type_value; }?>"/>
       <input type="hidden" class="fieldcstrate" name="fieldcstrate[]" value="<?php if($detaildata->rate_type == 'C') { echo $detaildata->rate_type_value; }?>"/>
        </td>
      
      
        <td><span id="price<?php echo $detaildata->id; ?>"><?php echo $detaildata->price; ?></span><input type="hidden"  name="detailprice[]" value="<?php echo $detaildata->price; ?>"/>
        <br/><span id="stax<?php echo $detaildata->id; ?>"><?php echo $detaildata->service_tax; ?></span><input type="hidden"  name="detailstax[]" class="detailstax" value="<?php echo $detaildata->service_tax; ?>"/>
        <input type="hidden"  name="stax_id[]" class="servicetaxid" value="<?php echo $detaildata->service_tax_id; ?>"/>
        </td>
        <td><span id="value<?php echo $detaildata->id; ?>"><?php echo $detaildata->value_cost; ?><input type="hidden"  name="detailvalue[]" value="<?php echo $detaildata->value_cost; ?>"/></span>
        <br/><span id="total<?php echo $detaildata->id; ?>"><?php echo $detaildata->total_value; ?></span><input type="hidden"  name="detaillisttotal[]" value="<?php echo $detaildata->total_value; ?>"/></td>
        <td><img src="<?php echo base_url(); ?>application/assets/images/delete.png" height='18' width='18' onclick='deleterowdb("detailtr",<?php echo $detaildata->id; ?>)'/><img src="<?php echo base_url(); ?>application/assets/images/edit.jpg" height='20' width='20' onclick='editrow("detailtr",<?php echo $detaildata->id; ?>)'/></td></tr>
	 <?php
     }
	 ?>
