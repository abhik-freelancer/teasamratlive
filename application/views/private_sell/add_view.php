<script src="<?php echo base_url(); ?>application/assets/js/privatesell.js"></script>
 ...
 <form role="form" method="post" name="addinvoice" id="addinvoice" action="<?php echo base_url(); ?>privatesell/savedata" method="post">
                    	...
                    	<td>
                        	  <table class="tablespace" >
                                       ...
                                       <tr>
                                        ...
                                        <td><div id="gardenerr"><select name="garden" id="garden" style="width: 190px">
                                        <option value="0">select</option>
                    	...
                    	<td>
                        				  <table class="tablespace" >
                                            ...
                                            <tr/>
                                             ...
                                             <td scope="row" >Net</td>
                                            <td><input type="text" id="net" name="net" onkeyup="checkDecimal(this)"/></td>
                                            <tr/>
                                            <tr>
...
<!--   <tr id="ratedropdowntr" style="display:none;">
  ...
  <tr>
    ...
    <td><input type="text" name="stampcharge" id="stampcharge"  style="text-align:right;"/></td>
  </tr>
  <tr>
    <td colspan="2"><hr/></td>
  </tr>
