<script src="<?php echo base_url(); ?>application/assets/js/stocktransferin_manage.js"></script> 
...
<h2><font color="#5cb85c">Manage Stock Transfer(IN)</font></h2>
...
<table class="masterTable">
  ...
  <tr>
        <td>Ref. No:</td>
        <td><input type="text" name="refrence_no" id="refrence_no" value="<?php echo $bodycontent['purchaseMaster']->purchase_invoice_number;?>"/> </td>
        <td>Transfer Date</td>
        <td><input type="text" class="datepicker" name="transferDt" id="transferDt" value="<?php echo $bodycontent['purchaseMaster']->transferDt;?>" /></td>
    </tr>
                              
   
  <tr>
    <td>Receipt Date</td>
    <td><input type="text" class="datepicker" id="receiptDt" name="receiptDt" value="<?php echo $bodycontent['purchaseMaster']->receiptDate;?>"/></td>
    <td>Vendor</td>
    <td> 
    ...
    <tr>
    <td>Challan No</td>
    <td><input type="text" id="challanNo" name="challanNo" value="<?php echo $bodycontent['purchaseMaster']->challan_no; ?>"/></td>
        ...
        <table class="gridtable" width="100%">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td>Location</td>
                        <td>
                            <select id="drpLocation_<?php echo ($dataContent['id']); ?>" name="drplocation[]">
                                <option value="0">Select</option>    
