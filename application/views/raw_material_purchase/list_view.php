 ...
 <h1><font color="#5cb85c" style="font-size:20px;">Raw Material Purchase List</font></h1>
 <div class="stats">
 
    <p class="stat"><a href="<?php echo base_url(); ?>rawmaterialpurchase/addRawMaterialpurchase" class="showtooltip" title="add">
	...
	<?php 
        ...
        if($bodycontent)  : 
         ...
         <tr>
             ...
             <td>
                 <a href="<?php echo base_url(); ?>rawmaterialpurchase/addRawMaterialpurchase/id/<?php echo($content['rawMatPurchMastId']); ?>" class="showtooltip" title="Edit">
