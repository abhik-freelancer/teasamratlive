<div style="text-align:center;text-shadow:2px 2px 8px #999"><h1><font face="Impact" size="9" color="white" >Welcome to <?php echo $companyname;?> </font></h1></div>
   ...
   <script type="text/javascript">
    ...
    <ul class="bxslider" style="text-align:center">
      ...
      <li style="text-align:center;"><img src="<?php echo base_url(); ?>application/assets/images/teagarden1.jpg" /></li>
