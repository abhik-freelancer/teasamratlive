<script src="<?php echo base_url(); ?>application/assets/js/journalVoucher.js"></script> 
 ...
 <h1><font color="#5cb85c" style="font-size:22px;">Journal Voucher(s)</font></h1>
 

<div class="stats">
  <p class="stat"><a href="<?php echo base_url(); ?>journalvoucher/addJournleVoucher" class="showtooltip" title="add"><img src="<?php echo base_url(); ?>application/assets/images/add.jpg" hieght="38" width="38" /></a></p>
 ...
 <table id="example" class="display" cellspacing="0" width="100%">
     ...
     <tbody>
         <?php foreach ($bodycontent['journalVouchrList'] as $row){?>
         <tr>
             ...
             <td>
                 <a href="<?php echo base_url(); ?>journalvoucher/addJournleVoucher/id/<?php echo($row['voucherMasterId']); ?>" class="showtooltip" title="Edit">
                  <img src="<?php echo base_url(); ?>application/assets/images/edit_ab.png" id="editTaxInvoice" title="" alt=""/>
                 </a>
                  <a href="<?php echo base_url(); ?>journalvoucher/print_item/vouchermasterId/<?php echo($row['voucherMasterId']); ?>" class="showtooltip" title="Pdf" target="_blank">
                 <img src="<?php echo base_url(); ?>application/assets/images/pdf.png" id="printJournalVoucher"  title="Pdf" alt="Pdf" width="20" height="20"/>
                 </a>
