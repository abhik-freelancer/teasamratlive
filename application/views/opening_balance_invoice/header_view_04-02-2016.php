...
<?php } ?>
        ...
        <label for="rate">Rate
            <br/>
            <input type="text" id="rate" name="rate" value="<?php echo $bodycontent['openingInvMstr']['price'] ?>" style="width:200px;"/>
        </label>
       ...
       <fieldset>
           <legend><span style="font-size:14px;">Normal Bag</span></legend>
             <input type="text" name="noofNormalBag" id="noofNormalBag" placeholder="No Of Bag" value="<?php echo $bodycontent['openingInvMstr']['no_of_bags'] ;?>"/>
             <input type="text" name="net" id="net" placeholder="Net" value="<?php echo $bodycontent['openingInvMstr']['net'] ;?>"/>
       </fieldset>
