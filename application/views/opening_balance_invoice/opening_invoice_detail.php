...
<div id="bagDetail_0_<?php echo($divnumber); ?>" class="opening_invoice_detail">
            <table width="100%" class="gridtable">
                        ...
                        <td width="20%">
                            <input type="text" class="noofbag" id="txtnoofbag_0_<?php echo($divnumber); ?>" name="txtnoofbag[]" value="" placeholder="No Of Bag" onkeyup="checkNumeric(this);"/></td>
                        <td width="20%"><input type="text" class="net" id="txtDetailNet_0_<?php echo($divnumber); ?>" name="txtDetailNet[]" value="" placeholder="Net" onkeyup="checkNumeric(this);"/></td>
