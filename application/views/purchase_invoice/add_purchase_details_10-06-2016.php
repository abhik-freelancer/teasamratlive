...
<div id="purchaseMaster" align="center">
    <input type="text" name="txtPmasterId" id="PmasterId" value="<?php echo($header['pmstId']); ?>"/>
    <input type="text" name="txtPurchaseType" id="PurchaseType" value="<?php echo($header['purchasetype']['from_where']); ?>"/>
</div>
<div id='detailDiv'>
