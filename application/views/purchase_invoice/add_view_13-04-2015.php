                  	...
                  	<tr>
                    	<td>
                        	  <table class="tablespace" >
                                       <tr>
                                        <td scope="row">LOT</td>
                                        <td><input type="text" id="lot" name="lot" tabindex="1" onkeyup="checkNumeric(this);"/></td>
                                        <td/>
                                       </tr>
                                       <tr>
                                        <td scope="row">DO</td>
                                        <td><input type="text" id="do" name="do" tabindex="2" onkeyup="checkNumeric(this);"/></td>
                                       </tr>
                                       <tr>
                                        <td scope="row">Group :</td>
                                        <td>
                                        	<div id="teagrouperr">
                                                    <select name="teagroup" id="teagroup" style="width: 190px" tabindex="3">
                                        ...
                                        <td><input type="text" id="invoice" name="invoice" tabindex="4"/></td>
                                       </tr>
                                         <tr>
                                        <td scope="row">Garden</td>
                                       
                                        <td><div id="gardenerr"><select name="garden" id="garden" style="width: 190px" tabindex="5">
                                        <option value="0">select</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                             <div id="wareerr">
                                                 <select name="warehouse" id="warehouse" style="width: 190px" tabindex="6">
                                            <option value="0">select</option>
                                            ...
                                            <td>
                                              <div id="gradeerr">
                                                  <select name="grade" id="grade" style="width: 190px" tabindex="7">
                                            <option value="0">select</option>
                        ...
                        <td>
                        			  <table class="tablespace" >
                                        <tr>
                                            ...
                                            <td><input type="text" id="brok" name="brok" tabindex="12"/></td>
                                            <tr/>
                                      	                                           
                                           <tr>
                                            <td scope="row" >Chest</td>
                                            <td><input type="text" id="chfrom" name="chfrom" tabindex="13"/> <input tabindex="14" type="text" id="chto" name="chto"/></td>
                                            <tr/>
                                            
                                           <tr>
                                            <td scope="row" >GP No</td>
                                            <td><input type="text" id="gpno" name="gpno" tabindex="15"/></td>
                                           <tr/>
                                            <tr>
                                            <td scope="row" >GP Date</td>
                                            <td><input type="text" class="datepicker" id="date" tabindex="16" name="date"/></td>
                                            <tr/>
                                            <tr>
                    ...
                    <tr>
                    	<td>
                        				  <table class="tablespace" >
                                            ...
                                            <td><input type="text" id="package" tabindex="8" name="package" onkeyup="checkNumeric(this)"/></td>
                                            <tr/>
                                            <tr>
                                            
                                             <td scope="row" >Stamp</td>
                                            <td><input type="text" id="stamp" name="stamp" tabindex="9"/></td>
                                            <tr/>
                                            
                                             <td scope="row" >Net</td>
                                            <td><input type="text" id="net" name="net" tabindex="10" onkeyup="checkDecimal(this)"/></td>
                                            <tr/>
                                            <tr>
                                             <td scope="row" >Gross</td>
                                            <td><input type="text" id="gross" name="gross" tabindex="11"/></td>
                                            <tr/>
                        ...
                        <td>
                                            ...
                                            <td><input type="text" id="price" name="price" tabindex="17"/></td>
                                            <tr/>
                                             <tr>
                                             <tr>
                                                 <td><input type="radio" name="type" value="V" class="call" checked="checked" tabindex="18">VAT</td>
