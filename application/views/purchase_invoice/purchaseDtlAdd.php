  ...
  <div id="dtlDiv_<?php echo($divnumber); ?>">
    <table class="gridtable" width="100%">
                    ...
                    <tr>
                        <td>Brokerage</td>
                        <td>
                            <input type="text" id="txtBrokerage_<?php echo($divnumber);?>" name="txtBrokerage[]" class="txtBrokerage" value=""/>
                ...
                <table class="gridtable" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                             ...
                             <input type="text" id="txtTbCharges_<?php echo($divnumber);?>" name="txtTbCharges[]" class="txtTbCharges" value=""/>
                        </td>
                        </tr>
                        <tr>
                            <td>Service Tax</td>
