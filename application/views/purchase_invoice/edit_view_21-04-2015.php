            ...
            <tr>
             ...
             <td colspan="4">
                 <select id="purchasetype" name="purchasetype">
                     <option value="AS" <?php if (($bodycontent['saveddata'][0]->from_where) == 'AS'): ?>selected="selected" <?php endif; ?>>Auction Sell</option>
                     <option value="PS" <?php if (($bodycontent['saveddata'][0]->from_where) == 'PS'): ?>selected="selected" <?php endif; ?>>Private Sell</option>
                     <option value="SB" <?php if (($bodycontent['saveddata'][0]->from_where) == 'SB'): ?>selected="selected" <?php endif; ?>>Seller to Buyers</option>
                 </select>
             </td>
         </tr>
            <tr>
