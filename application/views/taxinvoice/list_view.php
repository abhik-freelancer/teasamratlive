<script src="<?php echo base_url(); ?>application/assets/js/taxInvoice.js"></script> 

 <h2><font color="#5cb85c">Sale Bill List</font></h2>
 <div class="stats">
 
    <p class="stat"><a href="<?php echo base_url(); ?>taxinvoice/addTaxInvoice" class="showtooltip" title="add">
	...
	<?php 
        ...
        if($bodycontent)  : 
         ...
         <tr>
             ...
             <td>
                 <a href="<?php echo base_url(); ?>taxinvoice/addTaxInvoice/id/<?php echo($content['saleBillMasterId']); ?>" class="showtooltip" title="Edit">
                 ...
                 <a href="<?php echo base_url(); ?>taxinvoice/printSaleBill/taxInvId/<?php echo($content['saleBillMasterId']); ?>" class="showtooltip" title="Print" target="_blank">
                 <img src="<?php echo base_url(); ?>application/assets/images/print_sheet.png" id="prnSaleBill"  title="Print" alt="Print"/>
                 </a>
                 <a href="<?php echo base_url(); ?>taxinvoice/print_item/taxInvId/<?php echo($content['saleBillMasterId']); ?>" class="showtooltip" title="Pdf" target="_blank">
