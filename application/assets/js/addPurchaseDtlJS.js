...
function purchaseDetailsAdd(){
    ...
    var basepath =  $("#basepath").val();
    var VouchrMastId = $("#voucherMastId").val();
    ...
    $.ajax({
        ...
        type: 'post',
        data: {
            PurchaseMasterId:PurchaseMasterId,VouchrMastId:VouchrMastId,vendor_id:vendor_id,
            PurchaseType:PurchaseType,
            lotnumber:LotNumber,doNumber:doNumber,
            doDate:doDate,invoice:invoiceNumber,stamp:stamp,gross:gross,brokerage:brokerage,TBcharges:TBcharges,
