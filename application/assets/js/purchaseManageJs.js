...
function getTotalTeaValue(puDtId){
    ...
    totalTeaCost = (parseFloat(brokerage)+ parseFloat(tbCharges) + parseFloat(vatAmount) + parseFloat(cstAmount)+ parseFloat(serviceTaxAmt)+ parseFloat(teaTotalPrice)+parseFloat(stampCharges)).toFixed(2);
...
function updatePurDtl(purchaseDtlId){
    ...
    if(validation(purchaseDtlId)){
        ...
        TBcharges = $("#txtTbCharges_"+purchaseDtlId).val();//27-09-2016
    ...
    $.ajax({
        ...
        data: {
            ...
            purchaseDetailId:purchaseDtlId,lotnumber:LotNumber,doNumber:doNumber,TBcharges:TBcharges,
  ...
  /* var transporterid = $("#transporterid").val();
   ...
   if(validMaster()){
        ...
        data: {
            ...
            challanno:challanno,challanDt:challanDt
        },
        success: function(data) {
