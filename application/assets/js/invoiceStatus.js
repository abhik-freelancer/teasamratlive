...
/*   View Stock Out Detail   */

$(".viewStockOutDtl").click(function(){
        var StockOutbgId=$(this).attr('id');
        var DtlId = StockOutbgId.split('_');
        var bagDtlId =DtlId[1]; 
       // var bl_DtlId=DtlId[1]; 
       ...
       $.ajax(
                 {
                            type: 'POST',
                            dataType : 'html',
                            url: basepath + "invoicestatus/StockOutDtlView",
                            data: {bagDtlId:bagDtlId},
                            success: function(data) {
                                $("#dtlRslt").html(data);
       ...
       $.ajax(
                 {
                            type: 'POST',
                            dataType : 'html',
                            url: basepath + "invoicestatus/RawTeaSaleDtlView",
                            data: {bagDtlId:bagDtlId},
                            success: function(data) {
                                $("#dtlRslt").html(data);
