				...
				"Confirm": function() {
					...
					var sample = "<table><tr><td>"+createspan+"<input type='hidden' name='detailsamplename[]' value='"+createspanhidden+"'/></td><td>=></td><td>"+samplenet+"<input type='hidden' name='detailsamplenet[]' value='"+samplenethidden+"'/></td></tr></table>";
						...
						$("#example2").append(
							...
							"<td>"+$('#lot').val()+
                                                        "<input type='hidden' name='detaillot[]' value='"+$('#lot').val()+"'/><br/>"+$('#do').val()+
                                                        "<input type='hidden' name='detaildo[]' value='"+$('#do').val()+"' />"+
                                                        "<input type='hidden' name='detailtableid[]' value='0'/></td>"+
							"<td>"+$('#invoice').val()+
                                                        "<input type='hidden' name='detailinvoice[]' value='"+$('#invoice').val()+"' /></td>"+
				...
				"Confirm": function() {
					...
					var sample = "<table><tr><td>"+
						...
						$("#detailtr"+rowid).html(
							...
							"<td>"+"<span id='lot"+rowid+"'>"+$('#lot').val()+"</span><input type='text' name='detailtableid[]' value='"+$('#detailtableid'+rowid).val()+"' /><input type='hidden' name='detaillot[]' value='"+$('#lot').val()+"'/><br/><span id='do"+rowid+"'>"+$('#do').val()+"</span><input type='hidden' name='detaildo[]' value='"+$('#do').val()+"' /></td>"+
							"<td><span id='invoice"+rowid+"'>"+$('#invoice').val()+"</span><input type='hidden' name='detailinvoice[]' value='"+$('#invoice').val()+"' /></td>"+
							"<td>"+ $("#garden option:selected" ).text()+"<input type='hidden' id='detailgardenid"+rowid+"' name='detailgardenid[]' value='"+ $("#garden option:selected" ).val()+"'/><br/>"+ $("#warehouse option:selected" ).text()+"<input type='hidden' id='detailwarehouseid"+rowid+"'  name='detailwarehouseid[]' value='"+ $("#warehouse option:selected" ).val()+"'/><br/>"+ $("#teagroup option:selected" ).text()+"<input type='hidden'  name='detailteagroupid[]' id='detailteagroupid"+rowid+"' value='"+ $("#teagroup option:selected" ).val()+"'/></td></td>"+
