...
function DetailTeaCost(puDtId){
    ...
    tbCharges = ($('#txtTbCharges_' + puDtId).val() == '' ? 0 : $('#txtTbCharges_' + puDtId).val());
    ...
    totalTeaCostInDetail = (parseFloat(Brokerage) + parseFloat(vatAmount) + parseFloat(cstAmount) + parseFloat(serviceTaxAmt) + parseFloat(teaPrice) + parseFloat(stampCharges)+ parseFloat(tbCharges)).toFixed(2);
...
function totalBrokeragesValue() {
    ...
    $(".txtBrokerage").each(function() {
     ...
     $("#txtBrokerageTotal").val(totalBrokerage.toFixed(2));
    return totalBrokerage.toFixed(2);
...
function allTotalOfCost() {
    ...
    ///
    finalCostofAllCost = parseFloat(teaValuesTotal) + parseFloat(finalBrokerage)+ parseFloat(TbChargesTotal) + parseFloat(finalServiceTax) + parseFloat(finalVatAmount) + parseFloat(finalCstAmount) + parseFloat(finalStamp)+parseFloat(otherCharges)+parseFloat(roundOff);
