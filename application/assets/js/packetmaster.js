    ...
    $("#save").click(function() {
       ...
       var qtyinBag = $("#QtyinBag").val();
        ...
        $.ajax({
            ...
            data: {packet: packet, packetQty: packetQty,QtyinBag:qtyinBag},
...
$(function() {
    ...
    $("#edit").click(function() {
        ...
        if (selected.length > 0) {
            ...
            $("#QtyinBag").val($('#QtyinBag'+selectedVal).html());
           ...
           // $('#whouse option[value='+warehouseId+']').attr('selected', 'selected');
            ...
            $("#update").click(function() {
                ...
                $.ajax({
                    ...
                    data: {id: id, packet: packet, packQty: pcktQty,QtyinBag:QtyinBag},
                    success: function(data)
                    {
                        ...
                        else
                        {
                            ...
                            $('#QtyinBag' + selectedVal).html($("#QtyinBag").val());
