$(document).ready(function() {
    ...
    $('.datepicker').datepicker({
     ...
     $("#addnewDtlDiv").click(function() {
         ...
         var debitcredit = "debitcredit_0_"+divSerialNumber;
             ...
             /* var amountDtl = getAMountForDtl();
                if(acctag=="PY"){
                    detailAmt = Totalcredit-amountDtl;
                }
                if(acctag=="RC"){
                    detailAmt = totalDebit-amountDtl;
                }*/
     ...
     $(document).on('change', ".paymentmode", function() {
      ...
      $(document).on('change', ".paymentType", function() {
       ...
       $.ajax({
            ...
            success: function(data){
              if(data==1){
                  $("#chqNo").attr("disabled","disabled");
                     $("#chqNo").val(" ");
                  $("#chqDate").attr("disabled","disabled");
                    $("#chqDate").val(" ");
              }else{
                  $("#chqNo").removeAttr("disabled");
                   $("#chqNo").val(checqno);
                  $("#chqDate").removeAttr("disabled");
                  $("#chqDate").val(checqdate);
              }
    ...
    /*   $(document).on('click', ".debitcredit", function() {
