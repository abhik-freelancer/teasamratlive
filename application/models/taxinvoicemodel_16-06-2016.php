     ...
     */
     public function insertintoSaleBillMaster($searcharray,$vMastId,$slno,$salebillno){
           ...
           $saleBillMaster = array();
            ...
            $saleBillMaster['taxinvoiceno'] = $salebillno; //  $searcharray['txtTaxInvoiceNo'];
...
function getCustomerAccId($cus_id,$compny){
      $sql = " SELECT  `account_master`.`id` FROM `account_master` INNER JOIN customer ON `account_master`.`account_name` = customer.`customer_name` "
