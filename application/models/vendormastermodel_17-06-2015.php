...
class vendormastermodel extends CI_Model{
	...
	function add($value)
	{
		...
		$accountmaster = array('account_name'=>$value['vendor_name'],'group_master_id'=>2);
		$this->db->insert('account_master', $accountmaster); 
		$insertmaster = $this->db->insert_id();
		
		//if($value['opening_balance'] != '')
		//{
			$accountopeningmaster = array('account_master_id' =>$insertmaster,'opening_balance' =>$value['opening_balance'],'company_id' =>$value['company_id'],'financialyear_id' =>$value['financialyear_id']);
		...
		$datavendor = array('vendor_name' =>$value['vendor_name'],'address' =>$value['address'],'account_master_id'=>$insertmaster,'tin_number'=>$value['tin_number'],'cst_number'=>$value['cst_number'],'pan_number'=>$value['pan_number'],'service_tax_number'=>$value['service_tax_number'],'GST_Number'=>$value['GST_Number'],'pin_number'=>$value['pin_number'],'state_id'=>$value['state_id']);
	...
	function modify($value)
	{
		...
		$datavendor = array('vendor_name' =>$value['vendor_name'],'address' =>$value['address'],'account_master_id'=>$value['account_master_id'],'tin_number'=>$value['tin_number'],'cst_number'=>$value['cst_number'],'pan_number'=>$value['pan_number'],'service_tax_number'=>$value['service_tax_number'],'GST_Number'=>$value['GST_Number'],'pin_number'=>$value['pin_number'],'state_id'=>$value['state_id']);
