...
class openinginvoicemodel extends CI_Model{
    ...
    public function getOpeningInvoiceBalanceList($cmpy,$year){
        $sql="SELECT  
                ...
                AND `purchase_invoice_master`.`company_id`=".$cmpy." AND `purchase_invoice_master`.`year_id`=".$year." GROUP BY `purchase_bag_details`.`purchasedtlid`";
     ...
     $purinvDtlInsert=array();
             ...
             //  $purinvDtlInsert['doRealisationDate']=   $openingPurInvInsert['doRealisationDate'];
              ...
              // $purinvDtlInsert['package']=  $openingPurInvInsert['package'];
               ...
               $purinvDtlInsert['cost_of_tea'] = $openingPurInvInsert['rate'];
...
public function insertsampleBagDtl($new_PurDtlid,$dtlArr){
    ...
    public function insertdo_to_transporter($newDtlId,$new_PurDtlid,$openingPurInvInsert){
        ...
        $insrtDoToTrans['transporterId']=7;
        $insrtDoToTrans['do']='';
 ...
 public function getStartDate($yr){
        
        $sql = "SELECT  `financialyear`.`start_date` FROM `financialyear` WHERE `financialyear`.id=".$yr;
