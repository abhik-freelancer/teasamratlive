...
class openingbalance extends CI_Controller {
    ...
    public function index() {
        ...
        if ($this->session->userdata('logged_in')) {
            ...
            $result['openingInvlist']=$this->openinginvoicemodel->getOpeningInvoiceBalanceList();
    ...
    public function insertData($searcharray){
        ...
        if ($this->session->userdata('logged_in')) {
            $date = date('Y-m-d');
                ...
                $openingPurInvInsert['purchase_invoice_date']=$date;
                $openingPurInvInsert['auctionareaid']=2;
                $openingPurInvInsert['vendor_id']=39;
              ...
              // $openingPurInvInsert['net'] =$searcharray['net'];
               ...
               // $openingPurInvInsert['price']=$searcharray[''];
                ...
                $openingPurInvInsert['service_tax_id']=11;
