...
class purchaseinvoice extends CI_Controller {
    ...
    public function updatePurchaseDetail() {
        ...
        $update = $this->purchaseinvoicemastermodel->updatePurchaseDetailData($data, $bagData, $NormalbagData);
...
public function updateOtherandRoundOff(){
  ...
  //  echo ('totalCost :'.$totalCost);
    ...
    $otherChargesUpdate = $this->purchaseinvoicemastermodel->updateOtherCharges($masterId,$update);
    ...
    public function addNewPurchaseDetails() {
       ...
       exit;*/
        ...
        $update = $this->purchaseinvoicemastermodel->insertNewPurchaseDetail($data,$purchType, $bagData, $NormalbagData);
