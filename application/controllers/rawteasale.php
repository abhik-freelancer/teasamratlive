...
class rawteasale extends CI_Controller {
    ...
    /*   $headercontent['cstRate'] = $this->rawteasalemodel->getCurrentcstrate($session['startyear'] . '-04-01', $session['endyear'] . '-03-31');
       $headercontent['vatpercentage'] = $this->rawteasalemodel->getCurrentvatrate($session['startyear'] . '-04-01', $session['endyear'] . '-03-31');*/
