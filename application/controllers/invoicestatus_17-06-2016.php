  ...
  public function showTeaStock()
    {
       ...
       if ($this->session->userdata('logged_in')) {
          ...
          // $result['mastData'] = $this->invoicestatusmodel->getMasterData($garden,$invoice,$lotNum,$grade,$inStock);
           $result['mastData'] = $this->invoicestatusmodel->getMasterData($garden,$invoice,$lotNum,$grade);
         
            $result['groupStock'] = $this->invoicestatusmodel->getTeaStock($garden,$invoice,$lotNum,$grade);
            
           /* echo "<pre>";
                print_r($result['groupStock']);
            echo "</pre>";*/
