           ...
           if($this->session->userdata('logged_in'))
           {
               ...
               $saleNo = "";
                $is_sent = "";
                 ...
                 $headercontent['sale_no']=$this->dototransportermodel->saleNumberList($cmpyid,$yearid);
              if($is_sent=='Y'){
                $result['doList'] = $this->dototransportermodel->getDoTransLists('',$saleNo,$cmpyid);
                $result['transporter'] = $this->transportmastermodel->transportlist();
                $result['isSentToTrans']=$is_sent;
               }else{
               
                
                $result['doList'] = $this->dototransportermodel->getDoTransLists('Y',$saleNo,$cmpyid);
                $result['transporter'] = $this->transportmastermodel->transportlist();
