  ...
  SET opbal := OpeningBalance;
   ...
   SET totdebit:=  (SELECT  IFNULL(SUM(VD.voucher_amount),0) 
	...
	ELSE
				...
				SET creditBalance:=0;
    END IF;
		INSERT INTO finaltab (_AccountId,_AccountName,_totalOpening ,_totalTransDebit,_totalTransCredit ,_totalClosingDebit,_totalClosingCredit)
		VALUES(AccountId,AccountName,OpeningBalance,totdebit,totcredit,debitBalance,creditBalance);
...
SELECT finaltab._AccountId,finaltab._AccountName AS Account,finaltab._totalOpening AS Opening,
