    ...
    public function insertVendorAdvance($searcharray){
        ...
        $session = sessiondata_method();
         if ($this->session->userdata('logged_in')) {
             ...
             $vendorMasterAdvance["vendoradvance"]=$searcharray["vendoradvance"];
             $vendorMasterAdvance["narration"] = $searcharray["narration"];
             $vendorMasterAdvance["voucherNumber"] = $this->getvouchernumber();
             $vendorMasterAdvance["voucherSerial"] = $this->generate_serial_no();
             $vendorMasterAdvance["lastSrNo"]=  $this->getSerialNumber();
